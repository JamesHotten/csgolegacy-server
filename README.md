...
- `sv_lan 1`
- `-insecure`
- 默认断线经济：`sm_lan_economy_ruleset 0`（保持原有/CS:GO Legacy 行为）；改为 `1` 可启用当前 CS2 规则
- 执行 `exec mr12` 会切换为 12 回合半场、MR3 加时，并自动启用当前 CS2 经济规则
